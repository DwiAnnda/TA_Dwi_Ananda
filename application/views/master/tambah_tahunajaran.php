              ...
              <div class="card-body col-md-6">
                  <form id="formTambah" action="" method="post">
                      <div class="modal-body">
                          <?php
                            $cekurutan = $this->db->query('SELECT * FROM tahunajaran ORDER BY urutan DESC');
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="nama_tahunajaran" class="form-control" id="nama_tahunajaran" value="<?= set_value('nama_tahunajaran'); ?>" placeholder="Isi Nama Tahun Ajaran">
                              <small class="text-danger"><?= form_error('nama_tahunajaran'); ?></small>
                          </div>
                          <div class="form-group">
                              <label for="semester">Semester</label>
                              <input type="number" name="smester" class="form-control" id="smester" value="<?= set_value('smester'); ?>" placeholder="Isi Semester">
