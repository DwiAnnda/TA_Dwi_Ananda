              ...
              <div class="card-body col-md-6">
                  <form id="formTambah" action="" method="post" enctype="multipart/form-data">
                      <div class="modal-body">
                          ...
                          <input type="hidden" name="foto_lama" class="form-control" id="foto_lama" value="<?= $masterpegawai['foto']; ?>">
                          ...
                          <div class="form-group">
                              <label for="ktp">Pilih KTP (kosongkan jika tidak ingin mengganti KTP)</label>
                              <div class="custom-file">
                          ...
                          <div class="form-group">
                              <label for="foto">Pilih Foto (kosongkan jika tidak ingin mengganti foto)</label>
                              <div class="custom-file">
