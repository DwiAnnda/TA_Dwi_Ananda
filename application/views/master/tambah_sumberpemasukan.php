      ...
      <section class="content">
          ...
          <div class="card">
              <div class="card-header">
                  <h3 class="card-title">Tambah Data Sumber Pemasukan</h3>
              </div>
              <div class="card-body col-md-6">
                  <form id="formTambah" action="" method="post">
                      <div class="modal-body">
                          <?php
                            $cekurutan = $this->db->query('SELECT * FROM sumberpemasukan ORDER BY urutan DESC');
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="nama_sumberpemasukan" class="form-control" id="nama_sumberpemasukan" value="<?= set_value('nama_sumberpemasukan'); ?>" placeholder="Isi Nama Sumber Pemasukan">
