                  ...
                  <form id="formTambah" action="" method="post">
                      ...
                      <div class="modal-body">
                          <div class="form-group">
                              ...
                              <input type="text" name="nama_jenistagihan" class="form-control" id="nama_jenistagihan" value="<?= $jenistagihan['nama_jenistagihan']; ?>" placeholder="Isi Nama Jenis Tagihan">
                              <small class="text-danger"><?= form_error('nama_jenistagihan'); ?></small>
                          </div>
                          <div class="form-group">
                              <label for="nominal">Nominal</label>
                              <input type="text" name="nominal" class="form-control" id="nominal" value="<?= "Rp. " . number_format($jenistagihan['nominal'], 0, ',', '.'); ?>" placeholder="Isi Nominal">
