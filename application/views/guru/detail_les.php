                          ...
                          <div class="card-body">
                              <div class="tab-content" id="custom-tabs-one-tabContent">
                                  ...
                                  <div class="tab-pane fade" id="custom-tabs-one-materi" role="tabpanel" aria-labelledby="custom-tabs-one-materi-tab">
                                      <div class="col-12">
                                          <div class="justify-content-between">
                                              <a href="<?= base_url('guru/tambah_materi/' . $id_les); ?>"><button type="button" class="btn btn-primary mb-2"><i class="fa fa-plus"></i> Tambah Data Materi</button></a>
                                          </div>
                                                  ...
                                                  <?php $no = 1;
                                                    ...
                                                    ?>
                                                      <tr>
                                                          ...
                                                          <td>
                                                              <a href="<?= base_url(); ?>guru/ubah_materi/<?= $id_les . '/' . $ft['id_materi']; ?>"><button type="button" class="btn btn-primary btn-sm"><i class=" fa fa-edit"></i> Ubah</button></a>
                                                              <a href="<?= base_url(); ?>guru/hapus_materi/<?= $id_les . '/' . $ft['id_materi']; ?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus data ini');"><i class="fa fa-trash"></i> Hapus</button></a>
                                                          </td>
                                                      </tr>
                                                  <?php $no++;
                                                    endforeach; ?>
                                  ...
                                  <div class="tab-pane fade" id="custom-tabs-one-soalganda" role="tabpanel" aria-labelledby="custom-tabs-one-soalganda-tab">
                                      <div class="col-12">
                                          <div class="justify-content-between">
                                              <a href="<?= base_url('guru/tambah_soalganda/' . $id_les); ?>"><button type="button" class="btn btn-primary mb-2"><i class="fa fa-plus"></i> Tambah Data Soal</button></a>
                                          </div>
                                          <table id="example2" class="table table-bordered table-striped">
                                              <thead>
                                              ...
                                              <tbody>
                                                  <?php $no = 1;
                                                    $soalganda = $this->db->get_where('soalganda', ['id_les' => $id_les])->result_array();
                                                    ...
                                                    ?>
                                                      <tr>
                                                          ...
                                                          <td>
                                                              <a href="<?= base_url(); ?>guru/ubah_soalganda/<?= $id_les . '/' . $ft['id_soalganda']; ?>"><button type="button" class="btn btn-primary btn-sm"><i class=" fa fa-edit"></i> Ubah</button></a>
                                                              <a href="<?= base_url(); ?>guru/hapus_soalganda/<?= $id_les . '/' . $ft['id_soalganda']; ?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus data ini');"><i class="fa fa-trash"></i> Hapus</button></a>
                                                          </td>
                                                      </tr>
                                                  <?php $no++;
                                                    endforeach; ?>
                                  ...
                                  <div class="tab-pane fade" id="custom-tabs-one-soalisian" role="tabpanel" aria-labelledby="custom-tabs-one-soalisian-tab">
                                      <div class="col-12">
                                          <div class="justify-content-between">
                                              <a href="<?= base_url('guru/tambah_soalisian/' . $id_les); ?>"><button type="button" class="btn btn-primary mb-2"><i class="fa fa-plus"></i> Tambah Data Soal</button></a>
                                          </div>
                                          <table id="example2" class="table table-bordered table-striped">
                                              <thead>
                                                  <tr>
                                              ...
                                              <tbody>
                                                  <?php $no = 1;
                                                    $soalisian = $this->db->get_where('soalisian', ['id_les' => $id_les])->result_array();
                                                    ...
                                                    ?>
                                                      <tr>
                                                          ...
                                                          <td><?= status_soal($ft['id_status']); ?></td>
                                                          <td>
                                                              <a href="<?= base_url(); ?>guru/ubah_soalisian/<?= $id_les . '/' . $ft['id_soalisian']; ?>"><button type="button" class="btn btn-primary btn-sm"><i class=" fa fa-edit"></i> Ubah</button></a>
                                                              <a href="<?= base_url(); ?>guru/hapus_soalisian/<?= $id_les . '/' . $ft['id_soalisian']; ?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus data ini');"><i class="fa fa-trash"></i> Hapus</button></a>
                                                          </td>
                                                      </tr>
                                                  <?php $no++;
                                                    endforeach; ?>
                                  ...
                                  <div class="tab-pane fade" id="custom-tabs-one-latihan" role="tabpanel" aria-labelledby="custom-tabs-one-latihan-tab">
                                      <div class="col-12">
                                          <div class="justify-content-between">
                                              <a href="<?= base_url('guru/tambah_latihan/' . $id_les); ?>"><button type="button" class="btn btn-primary mb-2"><i class="fa fa-plus"></i> Tambah Data Latihan</button></a>
                                          </div>
                                          <table id="example2" class="table table-bordered table-striped">
                                              <thead>
                                                  <tr>
                                                  ...
                                                  <?php $no = 1;
                                                    ...
                                                    ?>
                                                      <tr>
                                                          ...
                                                          <td><?= status_soal($ft['id_status']); ?></td>
                                                          <td>
                                                              <a href="<?= base_url(); ?>guru/detail_latihan/<?= $id_les . '/' . $ft['id_latihan']; ?>"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-info"></i> Detail</button></a>
                                                              <a href="<?= base_url(); ?>guru/ubah_latihan/<?= $id_les . '/' . $ft['id_latihan']; ?>"><button type="button" class="btn btn-primary btn-sm"><i class=" fa fa-edit"></i> Ubah</button></a>
                                                              <a href="<?= base_url(); ?>guru/hapus_latihan/<?= $id_les . '/' . $ft['id_latihan']; ?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus data ini');"><i class="fa fa-trash"></i> Hapus</button></a>
                                                          </td>
                                                      </tr>
                                                  <?php $no++;
                                                    endforeach; ?>
