          ...
          <div class="card">
              ...
              <div class="card-body">
                  <div class="justify-content-between">
                      <a href="<?= base_url('register/tambah_materi'); ?>"><button type="button" class="btn btn-primary mb-2"><i class="fa fa-plus"></i> Tambah Data</button></a>
                  </div>
                          ...
                          <?php $no = 1;
                            ...
                            ?>
                              <tr>
                                  ...
                                  <td>
                                      <a href="<?= base_url(); ?>register/detail_materi/<?= $ft['id_materi']; ?>"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-info"></i> Detail</button></a>
                                      <a href="<?= base_url(); ?>register/ubah_materi/<?= $ft['id_materi']; ?>"><button type="button" class="btn btn-primary btn-sm"><i class=" fa fa-edit"></i> Ubah</button></a>
                                      <a href="<?= base_url(); ?>register/hapus_materi/<?= $ft['id_materi']; ?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus data ini');"><i class="fa fa-trash"></i> Hapus</button></a>
                                  </td>
                              </tr>
                          <?php $no++;
                            endforeach; ?>
