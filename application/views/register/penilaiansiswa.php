          ...
          <div class="card">
              ...
              <div class="card-body">
                  <div class="justify-content-between">
                      ...
                      <a href="<?= base_url('register/tambah_penilaiansiswa/' . $id_siswa) ?>"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</button></a>
                  </div>
                          ...
                          <?php
                            ...
                            foreach ($penilaiansiswa as $pnsiswa) : ?>
                              ...
                              <tr>
                                  ...
                                  <td><?= $nilai['abjad']; ?></td>
                                  <td>
                                      <a href="<?= base_url(); ?>register/hapus_penilaiansiswa/<?= $pnsiswa['id_penilaiansiswa']; ?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus data ini');"><i class="fa fa-trash"></i> Hapus</button></a>
                                  </td>
                              </tr>
                          <?php $no++;
                            endforeach; ?>
