                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control select2 select2-hidden-accessible" name="id_matapelajaran" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                  <?php
                                    ...
                                    ?>
                                  <option value="<?= $matapelajaran['id_matapelajaran']; ?>"><?= $pilihpegawai['nama_pegawai'] . ' Kelas :' . $nama_kelas . ' MatPel :' . $matapelajaran['nama_matapelajaran']; ?></option>
                                  <?php
                                    $matapelajaran = $this->db->order_by('id_guru', 'asc')->get_where('matapelajaran')->result_array();
