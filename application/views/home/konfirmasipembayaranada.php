<div class="col-4">
    ...
    <div class="card card-outline card-success">
        ...
        <div class="card-body">
            <p class="login-box-msg">Silahkan lengkapi konfirmasi pembayaran dibawah ini.</p>
            ...
            <div class="modal-body">
                ...
                <form id="formTambah" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nominal" class="form-control" id="nominal" value="<?= rupiah($tagihan['nominal']); ?>" readonly>
