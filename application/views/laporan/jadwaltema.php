                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 select2-hidden-accessible" name="id_kelassiswa" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                                ...
                                                ?>
                                                    <option value="<?= $jb['id_kelassiswa']; ?>"><?= $kelas['nama_kelas'] . ' Tahun : ' . $tahunajaran['nama_tahunajaran'] . '/' . $tahunajaran['smester'] . ' Guru : ' . $pegawaiguru['nama_pegawai']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="invoice p-3 mb-3">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($filter as $ft) : ?>
                                                    <?php
                                                    $id_kelassiswa = $ft['id_kelassiswa'];
                                                    $id_guru = $ft['id_guru'];
                                                    $guru = $this->db->get_where('guru', ['id_guru' => $id_guru])->row_array();
                                                    $pegawai_idguru = $guru['id_pegawai'];
                                                    $pegawaiguru = $this->db->get_where('pegawai', ['id_pegawai' => $pegawai_idguru])->row_array();
                                                    $id_kelas = $ft['id_kelas'];
                                                    $kelas = $this->db->get_where('kelas', ['id_kelas' => $id_kelas])->row_array();
                                                    $id_tahunajaran = $ft['id_tahunajaran'];
                                                    $tahunajaran = $this->db->get_where('tahunajaran', ['id_tahunajaran' => $id_tahunajaran])->row_array();
                                                    $jadwaltema = $this->db->get_where('jadwaltema', ['id_kelassiswa' => $id_kelassiswa])->result_array();
                                                    foreach ($jadwaltema as $jadwal) {
                                                        $tanggal = $jadwal['tanggal'];
                                                        $id_tema = $jadwal['id_tema'];
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        <form id="formTambah" action="<?= base_url('laporan/cetakjadwaltema'); ?>" method="post" target="_blank">
