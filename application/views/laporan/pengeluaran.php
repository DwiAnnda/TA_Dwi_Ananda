        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                        ...
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label>Filter Sumber Pengeluaran :</label>
                                            <select class="form-control select2 select2-hidden-accessible" name="input_sumberpengeluaran" style="width: 100%;" tabindex="-1" aria-hidden="true">
                ...
                <?php if (($this->session->flashdata()) and (isset($input_sumberpengeluaran))) : ?>
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="invoice p-3 mb-3">
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        <form id="formTambah" action="<?= base_url('laporan/cetakpengeluaran'); ?>" method="post" target="_blank">
                                            <input type="hidden" class="form-control" name="input_sumberpengeluaran" value=<?= $input_sumberpengeluaran; ?>>
