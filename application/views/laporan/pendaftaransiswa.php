                        ...
                        <div class="invoice p-3 mb-3">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($filter as $ft) :
                                                $kelas = $this->db->get_where('kelas', ['id_kelas' => $ft['id_kelas']])->row_array();
                                            ?>
                                                <tr>
                                                    <td><?= $no; ?></td>
                                                    <td><?= $ft['kode']; ?></td>
                            ...
                            <?php if (($this->session->flashdata()) and (isset($periode))) : ?>
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        <form id="formTambah" action="<?= base_url('laporan/cetakpendaftaransiswa'); ?>" method="post" target="_blank">
