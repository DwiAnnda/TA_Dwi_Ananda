                      ...
                      <?php
                        ...
                        ?>
                          <div class="col-lg-6">
                              <div class="card card-primary card-outline">
                                  <div class="card-header">
                                      <h5 class="m-0">Kelas Siswa</h5>
                                  </div>
                                  <div class="card-body">
                                      <h6 class="card-title">Menu Kelas Siswa</h6>

                                      <p class="card-text">Data Kelas Siswa masing-masing Guru.</p>
                                      <a href="<?= base_url('kelassiswa'); ?>" class="btn btn-primary"><i class="nav-icon fas fa fa-user"></i> Menu Kelas Siswa</a>
                                  </div>
                              </div>
                          </div>
                      <?php } ?>
