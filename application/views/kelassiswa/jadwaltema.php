          ...
          <div class="card">
              ...
              <div class="card-body">
                  <div class="justify-content-between">
                      ...
                      <a href="<?= base_url('kelassiswa/tambah_jadwaltema/' . $id_kelassiswa) ?>"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</button></a>
                  </div>
                          ...
                          <?php
                            ...
                            foreach ($jadwaltema as $jdwal) : ?>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a href="<?= base_url(); ?>kelassiswa/hapus_jadwaltema/<?= $jdwal['id_jadwaltema']; ?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus data ini');"><i class="fa fa-trash"></i> Hapus</button></a>
                                  </td>
                              </tr>
                          <?php $no++;
                            endforeach; ?>
