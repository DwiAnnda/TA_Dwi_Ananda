  ...
  <div class="content-wrapper">
      ...
      <section class="content">
          ...
          <div class="card">
              ...
              <div class="card-body">
                  <div class="row mb-3">
                      <a href="<?= base_url('kelassiswa/tambah_kenaikankelas') ?>"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</button></a>
                  </div>
                          ...
                          <?php $no = 1;
                            foreach ($kenaikankelas as $kkls) : ?>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a href="<?= base_url(); ?>kelassiswa/detail_kenaikankelas/<?= $kkls['id_kenaikankelas']; ?>"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-info"></i> Detail</button></a>
                                      <a href="<?= base_url(); ?>kelassiswa/ubah_kenaikankelas/<?= $kkls['id_kenaikankelas']; ?>"><button type="button" class="btn btn-primary btn-sm"><i class=" fa fa-edit"></i> Ubah</button></a>
                                      <a href="<?= base_url(); ?>kelassiswa/hapus_kenaikankelas/<?= $kkls['id_kenaikankelas']; ?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus data ini');"><i class="fa fa-trash"></i> Hapus</button></a>
                                  </td>
                              </tr>
                          <?php $no++;
                            endforeach; ?>
