                              ...
                              <div class="tab-content" id="custom-tabs-one-tabContent">
                                  ...
                                  <div class="tab-pane fade" id="custom-tabs-one-daftarsiswa" role="tabpanel" aria-labelledby="custom-tabs-one-daftarsiswa-tab">
                                      <div class="justify-content-between mb-3">
                                          <a href="<?= base_url('kelassiswa/tambah_daftarsiswa/' . $id_kelassiswa) ?>"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Daftar Siswa</button></a>
                                      </div>
                                      <div class="col-12">
                                          <?php
                                                      ...
                                                      <?php $no = 1;
                                                        ...
                                                        ?>
                                                          <tr>
                                                              ...
                                                              <td>
                                                                  <a href="<?= base_url(); ?>kelassiswa/absensi/<?= $list['id_siswa']; ?>/<?= $id_kelassiswa; ?>"><button type="button" class="btn btn-success btn-sm mr-5"><i class="fa fa-plus"></i> Absensi</button></a>
                                                                  <a href="<?= base_url(); ?>kelassiswa/hapus_daftarsiswa/<?= $list['id_daftarsiswa']; ?>/<?= $id_kelassiswa; ?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menghapus data ini');"><i class="fa fa-trash"></i> Hapus</button></a>
                                                              </td>
                                                          </tr>
                                                      <?php $no++;
                                                        endforeach; ?>
